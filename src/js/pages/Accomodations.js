        ...
        <div class="flex-center position-ref extra-margin-top">
          <div class="content curved-edges">
            ...
            <div class="flex-center image-margin">
              <img src="../../images/hotels/roger_outside.jpg" class="rounded-image"/>
            </div>
            ...
            <p>Call Reservations: (888) 448.7788 or (212) 448.7000 and refer to the Halliday-Bisa Wedding</p>

            <p>Email Reservations: reservations@therogernewyork.com and refer to the Halliday-Bisa Wedding</p>
            ...
            <br/>
            <div class="flex-center image-margin">
              <img src="../../images/hotels/roger_inside.png" class="rounded-image"/>
            </div>
            <br/>
          </div>
        </div>
